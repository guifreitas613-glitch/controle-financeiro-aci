...
import { ProspectsView } from './components/ProspectView';
...
import {
  DashboardIcon, TransactionsIcon, GoalsIcon, ReportsIcon, SettingsIcon,
  PartnershipIcon, PlusIcon, EditIcon, TrashIcon, RefreshCwIcon, CloseIcon,
  MenuIcon, ExportIcon, UploadIcon, SearchIcon, LogoutIcon, ArrowUpIcon,
  ArrowDownIcon, InfoIcon, AlertCircleIcon, CheckCircleIcon, FileTextIcon,
  TrendingUpIcon, DownloadIcon, WalletIcon, ArrowUpRightIcon, ArrowDownRightIcon,
  ScaleIcon, TargetIcon, PrinterIcon, Card, Button, Modal, ProgressBar
